...
# 5. Copy all server log files from ./data/raw to ./data/processed/server_logs
...
# 7. Remove all files with "ipaddr" in the filename from ./data/raw and ./data/processed/user_logs
